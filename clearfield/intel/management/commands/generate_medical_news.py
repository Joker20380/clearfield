...
- Не обобщай результат единичного клинического случая до утверждения, что раннее выявление, своевременная диагностика или лечение в целом предотвращают заболевание, осложнение или смерть.
- Если источник сообщает, что в конкретном случае удалось не допустить осложнения, передавай это только как исход этого случая, без универсального профилактического вывода.
...
- Не превращай результат лечения одного пациента в общий вывод,
  что раннее выявление, своевременная диагностика или лечение
  предотвращают заболевания, осложнения или смерть.
- Результат конкретного клинического случая передавай только
  применительно к этому пациенту и только в формулировке,
  подтверждённой исходными фактами.
